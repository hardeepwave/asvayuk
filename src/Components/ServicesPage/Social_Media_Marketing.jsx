...
const Social_Media_Marketing = () => {
    return (
        <>
            <Meta_Component
                title="Top Social Media Marketing Services by Asvayuk Technologies"
                description="At Asvayuk Technologies, we offer top-tier social media marketing services to help you connect with your audience, enhance brand visibility, and drive sales."
                        ...
                        <Row>
                            <Col lg={6} md={6} className='col-12'>
                                <Breadcrumb>
                                    ...
                                    <Breadcrumb.Item active>Social Media Marketing</Breadcrumb.Item>
                                </Breadcrumb>
                                <div className="peformance_section_top-heading perTitle mt-3">
                                    <h2>
                                        Market smarter with our proven social media marketing strategies
                                    </h2>
                                    <p>
                                        Our services open doors to limitless possibilities and unparalleled engagement. By harnessing social platforms, we create buzz around your brand, cultivate communities, and accelerate your business growth.
                                    </p>
                    ...
                    <div className="container">
                        <div className="col-12">
                            <div className="peformance_card2_heading text-center">
                                <h2>Our Comprehensive Social Media Marketing Services</h2>
                                <p className="mt-3">Our spectrum of services is meticulously designed to cater to your unique business needs, and here's a glimpse of what we bring to your brand:.</p>
                            </div>

                                ...
                                <div className="col-12">
                                    ...
                                    <div className="performance_card2_inner-sec mt-5">
                                        <div className="row">
                                          <div className="ecommerce_cards d-lg-flex justify-content-center gap-4 d-block">
                                                <div className="col-lg-4 pb-4 d-flex">
                                                    <ServicesCard ServiceCardImg={c14} cardHeading='Best eCommerce Website Designing Company in Chandigarh' cardParaGraph={<>Asvayuk Technologies Private Ltd. is a top-rated eCommerce Website Designing Company in Chandigarh, providing cutting-edge solutions to help businesses build a strong online presence. Whether a startup or an established brand, our expert team ensures a seamless shopping experience for your customers.</>} />
                                                </div>
                                                <div className="col-lg-4 pb-4 d-flex">
                                                    <ServicesCard ServiceCardImg={c15} cardHeading='Expert eCommerce Website Designing & Development in Chandigarh' cardParaGraph={<>We design and develop feature-rich, secure, and user-friendly eCommerce websites tailored to your business needs. As a trusted eCommerce Website Designing Company in Chandigarh, we specialize in Shopify, Magento, WooCommerce, and custom-built platforms for maximum scalability and performance.</>} />
                                                </div>
                                                <div className="col-lg-4 pb-4 d-flex">
                                                    <ServicesCard ServiceCardImg={c16} cardHeading='Leading eCommerce Website Development Company in Chandigarh' cardParaGraph={<>Looking for a reliable eCommerce Website Development Company in Chandigarh? Asvayuk Technologies Private Ltd. specializes in creating high-performance, secure, and scalable online stores. Let’s build your dream eCommerce website with seamless functionality, mobile responsiveness, and advanced features to elevate your business to new heights.</>} />
                                                </div>
                                          </div>
                                        </div>
                                    </div>
